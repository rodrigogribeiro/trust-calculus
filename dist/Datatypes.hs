...
coq_CompSpecT_rect :: a1 -> a1 -> (() -> a2) -> (() -> a2) -> (() -> a2) ->
                      Coq_comparison -> (CompSpecT a1) -> a2
coq_CompSpecT_rect x y f f0 f1 c c0 =
  case c0 of {
   CompEqT -> f __;
   CompLtT -> f0 __;
   CompGtT -> f1 __}

coq_CompSpecT_rec :: a1 -> a1 -> (() -> a2) -> (() -> a2) -> (() -> a2) ->
                     Coq_comparison -> (CompSpecT a1) -> a2
coq_CompSpecT_rec x y =
  coq_CompSpecT_rect x y
